...
* **breed\_labels.csv** - Contains Type, and BreedName for each BreedID. Type 1 is dog, 2 is cat.
* **color\_labels.csv** - Contains ColorName for each ColorID
* **state\_labels.csv** - Contains StateName for each StateID
...
[https://cloud.google.com/natural-language/docs/basics](https://cloud.google.com/natural-language/docs/basics)
